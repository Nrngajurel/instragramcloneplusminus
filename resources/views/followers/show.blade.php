    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                ...
                <ul class="">
                    @foreach($user->profile->followers as $followers)
                        <div class="list-group ">

                            <li class="list-group-item list-unstyled w-100  d-flex justify-content-between">

                                <span>
                                    <a href="{{ route('profile.show',$followers->id) }}">{{ $followers->username }}</a></span> <span>{{ random_int(1,60) }} minuts Ago | Active</span>
                            </li>
                        </div>
